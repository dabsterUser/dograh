...
class TelnyxProvider(TelephonyProvider):
    ...
    async def initiate_call(
        ...
        **kwargs: Any,
        ...
        # stream_bidirectional_codec controls only the CallAgent → Telnyx direction.
        # The Telnyx → CallAgent direction follows the PSTN leg and is announced via
    ...
    async def handle_websocket(
        ...
        try:
            ...
            # inbound direction (Telnyx → CallAgent); the outbound direction is
