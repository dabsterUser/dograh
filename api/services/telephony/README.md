...
This module implements the telephony provider abstraction for CallAgent AI. For user-facing documentation, see the [Mintlify docs](https://docs.callagent.ai/integrations/telephony/overview).
...
See the [Custom Provider Guide](https://docs.callagent.ai/integrations/telephony/custom) in the documentation for detailed implementation instructions.
...
- [User Documentation](https://docs.callagent.ai/integrations/telephony/overview)
- [Twilio Integration](https://docs.callagent.ai/integrations/telephony/twilio)
- [Custom Providers](https://docs.callagent.ai/integrations/telephony/custom)
- [Webhooks Guide](https://docs.callagent.ai/integrations/telephony/webhooks)
