...
export type ClientOptions = {
    baseUrl: 'https://app.callagent.ai' | 'http://localhost:8000' | (string & {});
};
...
export type CurrentUsageResponse = {
    ...
    period_end: string;
    /**
     * Used CallAgent Tokens
     */
    used_callagent_tokens: number;
    /**
     * Quota CallAgent Tokens
     */
    quota_callagent_tokens: number;
    /**
     * Percentage Used
     */
...
export type DailyUsageBreakdownResponse = {
    ...
    /**
     * Total CallAgent Tokens
     */
    total_callagent_tokens: number;
    /**
     * Currency
     */
    currency?: string | null;
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by CallAgent from fixed values or workflow context templates
     */
...
export type WorkflowRunUsageResponse = {
    ...
    created_at: string;
    /**
     * CallAgent Token Usage
     */
    callagent_token_usage: number;
    /**
